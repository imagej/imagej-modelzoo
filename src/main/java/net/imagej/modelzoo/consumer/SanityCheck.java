...
public class SanityCheck {
	...
	public static <T extends RealType<T>, U extends RealType<U>> void compare(Dataset gt, Dataset input, Dataset output, RandomAccessibleInterval<T> modelDemoInput, RandomAccessibleInterval<U> modelDemoOutput, OpService opService) {
		compare(
	...
	private static Component getPSNRInfo() {
		String text2 = "<html><p style='font-weight: normal;'>Calculating the PSNR between the Ground Truth and the Sanity Check Input" +
				" is a measure for how noisy the Input Image is compared to the Ground Truth." +
				" The PSNR between the Ground Truth and the Model Prediction, in contrast, " +
				" represents how noisy the prediction based on the trained model is compared to the Ground Truth." +
