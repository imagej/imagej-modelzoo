...
public class E01_Prediction {
	...
	public void useService() throws IOException {
		...
		String modelPath = getClass().getResource("/net/imagej/modelzoo/consumer/commands/denoise2D/model.zip").getPath();
		...
		RandomAccessibleInterval output = modelZooService.predict(input, modelPath);
