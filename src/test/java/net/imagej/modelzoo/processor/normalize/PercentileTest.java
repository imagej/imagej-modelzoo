...
package net.imagej.modelzoo.processor.normalize;
...
public class PercentileTest {
		...
		float[] percentiles)
	{
		...
		net.imagej.modelzoo.processor.normalize.Percentile normalizer = new HistogramPercentile<>();
		ImageJ ij = new ImageJ();
