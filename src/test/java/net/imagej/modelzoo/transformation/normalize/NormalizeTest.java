...
public class NormalizeTest {
		...
		double[] percentiles)
	{
		...
		PercentileNormalizer normalizer = new PercentileNormalizer(new float[]{3.0f, 99.8f}, new float[]{0,1}, true);
		...
		RandomAccessibleInterval res1 = normalizer.normalize(dataset);
		...
		RandomAccess<FloatType> raRes1 = (RandomAccess<FloatType>) res1.randomAccess();
